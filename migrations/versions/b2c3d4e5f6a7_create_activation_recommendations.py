...
def upgrade() -> None:
    op.create_table('activation_recommendations',
    ...
    with op.batch_alter_table('activation_recommendations', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_activation_recommendations_analysis_run_id'), ['analysis_run_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_activation_recommendations_playbook_id'), ['playbook_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_activation_recommendations_recommended_motion'), ['recommended_motion'], unique=False)
