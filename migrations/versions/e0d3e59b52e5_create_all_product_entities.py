...
def upgrade() -> None:
    ...
    op.create_table('action_brief_records',
    sa.Column('id', sa.String(length=36), nullable=False),
    ...
    op.create_table('gap_diagnosis_records',
    sa.Column('id', sa.String(length=36), nullable=False),
    sa.Column('analysis_run_id', sa.String(length=36), nullable=False),
    ...
    with op.batch_alter_table('gap_diagnosis_records', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_gap_diagnosis_records_analysis_run_id'), ['analysis_run_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_gap_diagnosis_records_created_at'), ['created_at'], unique=False)

    op.create_table('product_readiness_checks',
    sa.Column('id', sa.String(length=36), nullable=False),
    ...
    with op.batch_alter_table('product_readiness_checks', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_product_readiness_checks_analysis_run_id'), ['analysis_run_id'], unique=False)
    ...
    op.create_table('nvidia_mapping_records',
    sa.Column('id', sa.String(length=36), nullable=False),
    sa.Column('analysis_run_id', sa.String(length=36), nullable=False),
    ...
    with op.batch_alter_table('nvidia_mapping_records', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_nvidia_mapping_records_analysis_run_id'), ['analysis_run_id'], unique=False)
        ...
        batch_op.create_index('ix_nvidia_mapping_run_gap_technology', ['analysis_run_id', 'addresses_gap', 'technology_name'], unique=False)
